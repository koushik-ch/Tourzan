...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY2hrb3VzaGlrIiwiYSI6ImNrenRjcXVlMjBiN3kybm53b3lsZGU3Z3MifQ.-sOfbQmWSvj6KF6wpeW-XA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/chkoushik/ckzthecjg001u14mfuutjwznw',
    scrollZoom: false // center:[80.030776,21.142924],
    // zoom:3.5
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('Login Successful', 'success');
          ...
          case 8:
            ...
            (0, _alerts.showAlert)("Login Failed, Incorrect email or password", "error");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('Successfully logged out', 'success');
              window.setTimeout(function () {
                window.location.href = '/';
              }, 500);
            }
          ...
          case 7:
            ...
            (0, _alerts.showAlert)("Logout Failed", "error");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('SignupSuccessful', 'success');
              window.setTimeout(function () {
                window.location.href = '/';
              }, 1000);
            }
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](1);
            (0, _alerts.showAlert)("Signup failed", "error");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('Successfully updated', 'success');
              window.setTimeout(function () {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)("Update Failed", "error");
...
var stripe = Stripe('pk_test_51KVnPESB43Ul39g9e7ymTcSbCvAHl3nbsYWC7lfriFTqUb7G4umdNztkCwD3dySfHcjLtZ5o9ztKUevVP3wsiQ3O009dqvZbrQ');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            (0, _alerts.showAlert)('Error, Payment failed', 'error');
